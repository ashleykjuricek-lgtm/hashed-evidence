# Article capture — BBC via Yahoo Tech, "Dramatic insider warnings over AI fall flat with some in Silicon Valley"

**Provenance.** Fetched 2026-09-12 (UTC evening) by Claude (Fable seat) at Ash's link,
`https://www.yahoo.com/tech/ai/articles/dramatic-insider-warnings-over-ai-172857563.html`,
which redirected (HTTP 308) to
`https://tech.yahoo.com/ai/articles/dramatic-insider-warnings-over-ai-172857563.html`.
Page metadata: title as above; author "Lily Jamali - North America Technology
correspondent in San Francisco"; provider BBC (syndicated on Yahoo);
datePublished 2026-09-13T00:13:17Z (that is the evening of 2026-09-12 in the US).
Raw HTML was 730,462 bytes; the 44 body paragraphs below were extracted by regex
from the `<p>` tags between the first and last article paragraph, HTML entities
decoded, whitespace collapsed, nothing else changed. Image captions, related-link
lines and "Watch:" lines that sat inside `<p>` tags are kept in place, since the
extraction does not distinguish them. Copyright is the BBC's; this capture is kept
for the record of what was responded to, not for republication.

**Why it is here.** Entry 117 responds to this article. The rule of 054 applies:
if any later summary of the article disagrees with this capture, this capture is
the record. The first summary Claude received (from a fetch tool's condensing
model) omitted the Mythos paragraphs, the White House fight, the Sanders bill and
the Trump quote entirely; the read in `the-read.md` was written from that
condensed version and is amended there.
...
Grindr CEO George Arison told the BBC he believed some of the stark public warnings about AI were "dangerous" [Getty Images]
...
Watch: "Slow it down" - Bernie Sanders proposes bill to ban AI superintelligence
